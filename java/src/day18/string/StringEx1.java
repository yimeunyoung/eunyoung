...
public class StringEx1 {
	...
	public static void main(String[] args) {
		/* 문자열 관련 메서드 */
		//indexOf : 기준 문자열에서 검색 또는 문자/문자열을 왼쪽부터 검색해서 처음으로 만나는 위치를 반환 => 리턴값이 '번지'
		//lastIndexOf : 기준 문자열에서 검색 또는 문자/문자열을 오른쪽부터 검색해서 처음으로 만나는 위치를 반환 
		...
		//contains : 기준 문자열에서 검색 또는 문자/문자열이 있는지 없는지를 알려줌
		...
		//replaceAll : '정규 표현식(문자열에 특정 패턴이 있는지)'에 맞는 모든 문자/문자열을 수정
