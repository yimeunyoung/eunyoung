...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//num3은 접근 제어자가 public => a.에서 ctrl + space 눌렀을 때 초록색으로 떠있는 num3은 모두 쓸수 있음을 표시
...
class A{
	 ...
	 */
	public void print() {
		//num1은 private이기 때문에 A클래스의 메서드에서 호출될 수 있다.
		//이미 알고있는 내 정보를 활용하는 경우 매개변수로 전달받지 않아도 됨 = public 뒤에 static이 안붙은 메서드의 경우는 내 정보(class A)안에 있는 정보를 활용할 경우
